...
export type getMesParams = {chatID: string};                
export type getMesResponse = { isMe: boolean, content: string }[];                
export const getMesApiPath = '/api/auth/getMes';    
export type sendMesParams = {chatID: string, message: string, date: string};                
export type sendMesResponse = { done: boolean };                
export const sendMesApiPath = '/api/auth/sendMes';    
export type recvMesParams = { chatID: string };                
export type recvMesResponse = { isMe: boolean, content: string }[];                
export const recvMesApiPath = '/api/auth/recvMes';    
